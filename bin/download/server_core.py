    ...
    if core_type == 'fabric':
        if core_installer.init_core_installer(core_type, core_support_version):
            ...
            try:
                ...
                os.system('powershell java -jar ' + program_info.work_path + program_info.fabric_core_installation_save + ' server -mcversion ' + core_support_version + ' -downloadMinecraft -dir "' + program_info.work_path + program_info.program_server_folder + '\\' + server_name + '"')
    ...
    if core_type == 'forge':
        if core_installer.init_core_installer(core_type, core_support_version):
            ...
            try:
                ...
                os.system('java -jar ' + program_info.work_path +program_info.forge_core_installation_save + ' --installServer "' + program_info.work_path + program_info.program_server_folder + '\\' + server_name + '"')
                os.remove(program_info.work_path + program_info.forge_core_installation_save)
