...
def get_server_storage_size(server_name):
    ...
    if find_file.find_files_with_existence(program.work_path + program.server_storage_size + '/' + f'{server_name}.json'):
        with open(program.work_path + program.server_storage_size + '/' + f'{server_name}.json', 'r', encoding='utf-8') as f:
